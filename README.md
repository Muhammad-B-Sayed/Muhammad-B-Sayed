...
- Designed the React + TypeScript client for task filtering, calendar event management, due-soon planning, and dashboard workflows.
- Added a production-minded workflow with Docker, Nginx, Maven, npm, and GitHub Actions checks.
...
**Always building, testing, and tightening the loop between idea and shipped product.**
